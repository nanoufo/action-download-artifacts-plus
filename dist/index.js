...
(function (Inputs) {
    ...
    Inputs["IfArtifactsOverlap"] = "if-artifacts-overlap";
...
function getInputs() {
    ...
    const inputs = {
        path: getStringInput(constants_1.Inputs.Path, { required: true }),
        names: getStringInput(constants_1.Inputs.Names, { required: true })
            .split("\n")
            .filter((line) => line.trim()),
        ifNoArtifactsFound: getFailureHandlingStrategyInput(constants_1.Inputs.IfNoArtifactFound, { required: true }),
        ifArtifactsOverlap: getFailureHandlingStrategyInput(constants_1.Inputs.IfArtifactsOverlap, { required: true }),
    };
    return inputs;
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const inputs_helper_1 = __nccwpck_require__(188);
const core_1 = __nccwpck_require__(186);
async function main() {
    try {
